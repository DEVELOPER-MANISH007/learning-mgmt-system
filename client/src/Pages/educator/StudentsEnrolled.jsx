...
useEffect(()=>{
 if(isEducator){
  ...
  return enrolledStudents && enrolledStudents.length > 0 ? (
    ...
    <div className=' border border-gray-500/50 flex flex-col items-center max-w-4xl w-full overflow-hidden '>
    ...
    {enrolledStudents.map((item,index)=>(
      <tr key={index} className='border-b border-gray-500/50'>
        <td className='px-4 py-3 text-center hiddensm:tablce-cell'>{index+1}</td>
